...
const mockBarbershops: Barbershop[] = [
  {
    ...
    phone: "+62 21 1234567",
    description:
      "Barbershop premium dengan layanan terbaik dan barber profesional",
    rating: 4.9,
    review_count: 128,
    opening_time: "09:00",
    closing_time: "21:00",
  ...
  },
  {
    ...
    distance: 3.1,
    image_url:
      "https://images.unsplash.com/photo-1504222226556-cf4ee9fd35a7?w=400&h=300&fit=crop",
  },
  {
    id: 3,
    ...
    phone: "+62 21 3456789",
    description:
      "Barbershop klasik dengan sentuhan modern dan fasilitas premium",
    rating: 4.5,
    review_count: 87,
    opening_time: "08:00",
    closing_time: "19:00",
    ...
    distance: 1.8,
    image_url:
      "https://images.unsplash.com/photo-1599504347989-b6b90d84c22c?w=400&h=300&fit=crop",
  },
  {
    id: 4,
    ...
    distance: 5.2,
    image_url:
      "https://images.unsplash.com/photo-1576868553619-2b9397cf1dba?w=400&h=300&fit=crop",
  },
  {
    id: 5,
    ...
    phone: "+62 21 5678901",
    description:
      "Barbershop dengan fasilitas lengkap dan nyaman untuk relaksasi",
    rating: 4.8,
    review_count: 112,
    opening_time: "09:30",
    closing_time: "21:30",
    ...
    distance: 4.5,
    image_url:
      "https://images.unsplash.com/photo-1621905251888-48416bd8575a?w=400&h=300&fit=crop",
  },
  {
    id: 6,
    ...
    phone: "+62 21 6789012",
    description:
      "Barbershop trendi dengan barber profesional dan inovasi terbaru",
    rating: 4.6,
    review_count: 78,
    opening_time: "10:00",
    closing_time: "21:00",
  ...
  },
  {
    ...
    phone: "+62 21 7890123",
    description:
      "Barbershop sederhana dengan hasil maksimal dan harga terjangkau",
    rating: 4.4,
    review_count: 64,
    opening_time: "09:00",
    closing_time: "18:00",
    ...
    distance: 3.3,
    image_url:
      "https://images.unsplash.com/photo-1605286372967-d06dbb5d0c90?w=400&h=300&fit=crop",
  },
  {
    id: 8,
    ...
    distance: 4.1,
    image_url:
      "https://images.unsplash.com/photo-1512941691920-25bda97eb744?w=400&h=300&fit=crop",
  },
];

export default function Home() {
  // const [barbershops, setBarbershops] = useState<Barbershop[]>(mockBarbershops);
  const [filteredBarbershops, setFilteredBarbershops] =
